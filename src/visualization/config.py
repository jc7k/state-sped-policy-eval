...
class PlotConfig:
    ...
    region_colors: dict[str, str] | None = field(default=None)

    # Private cache for style dictionary
    _style_cache: dict[str, any] | None = field(default=None, init=False, repr=False)
...
COLOR_SCHEMES = {
    ...
    "policy_reform": [
        ...
        "#fee08b",
        "#d73027",
    ],  # Blue to red for treatment intensity
...
SIGNIFICANCE_LEVELS = {"p001": 0.001, "p01": 0.01, "p05": 0.05, "p10": 0.10}
