...
class FilePatterns:
    ...
    # NAEP file patterns
    NAEP_PATTERNS = ["naep_state_swd_data.csv", "naep_*_swd_*.csv", "naep_achievement_*.csv"]
    ...
    EDFACTS_PATTERNS = {
        2019: ["bchildcountandedenvironment2019.csv", "bchildcountandedenvironment2019-20.csv"],
        2020: ["bchildcountandedenvironment2020.csv", "bchildcountandedenvironment2020-21.csv"],
        2021: ["bchildcountandedenvironment2021.csv", "bchildcountandedenvironment2021-22.csv"],
        2022: ["bchildcountandedenvironment2022.csv", "bchildcountandedenvironment2022-23.csv"],
        2023: ["bchildcountandedenvironment2023.csv", "bchildcountandedenvironment2023-24.csv"],
    }
...
class OutputSettings:
    ...
    DEFAULT_DIRS = {"raw": "data/raw", "processed": "data/processed", "final": "data/final"}
