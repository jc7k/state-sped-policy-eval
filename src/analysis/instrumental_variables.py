...
class InstrumentalVariablesAnalyzer:
    ...
    def _run_first_stage(self, data: pd.DataFrame) -> dict[str, float]:
        ...
        try:
            ...
            instrument_indices = [
                i for i, col in enumerate(X_instruments.columns) if col in instrument_cols
            ]
    ...
    def estimate_iv_effects(
        ...
        try:
            ...
            results = {
                ...
                "overid_pvalue": getattr(iv_results, "j_statistic", {}).get("pvalue", np.nan)
    ...
    def compare_ols_iv_estimates(
        ...
        try:
            ...
            if iv_results:
                ...
                hausman_pvalue = (
                    1 - stats.chi2.cdf(hausman_stat, 1) if not np.isnan(hausman_stat) else np.nan
                )
