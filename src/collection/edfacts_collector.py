...
class EdFactsCollector(FileBasedCollector):
    ...
    def __init__(self, rate_limit_delay: float = 1.0):
        ...
        self.osep_base_url = (
            "https://www2.ed.gov/programs/osepidea/618-data/state-level-data-files/part-b-data"
        )
    ...
    def try_download_patterns(self, data_type: str, year: int, output_dir: Path) -> Path | None:
        """
