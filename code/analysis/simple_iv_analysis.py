...
class SimpleIVAnalyzer:
    ...
    def __init__(self, data_path: str = "data/final/analysis_panel.csv"):
        ...
        print(f"SimpleIVAnalyzer initialized:")
    ...
    def manual_2sls_estimation(self, outcome: str) -> Dict[str, float]:
        ...
        instrument_indices = [1, 2]  # court_ordered, under_monitoring positions
        ...
        iv_se = second_stage.bse['post_treatment_predicted'] * np.sqrt(len(analysis_data) / (len(analysis_data) - X2.shape[1]))
