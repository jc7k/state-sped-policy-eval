...
class EventStudyVisualizer:
    ...
    def __init__(
        self, results_dir: str = "output/tables", figures_dir: str = "output/figures"
    ):
        ...
        print("EventStudyVisualizer initialized:")
    ...
    def plot_event_study(
        ...
        if outcome not in self.results:
            raise ValueError(
                f"Outcome {outcome} not found. Available: {list(self.results.keys())}"
            )
...
if __name__ == "__main__":
    ...
    print(f"Outcomes processed: {len([k for k in all_plots if k != 'summary'])}")
