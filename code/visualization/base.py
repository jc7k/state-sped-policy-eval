...
class BaseVisualizer(ABC):
    ...
    def __init__(
        self,
        results_dir: Union[str, Path] = "output/tables",
        figures_dir: Union[str, Path] = "output/figures", 
    ...
    def _load_csv_file(
        ...
        for file_path in files:
            try:
                ...
                outcome = self._extract_outcome_from_filename_optimized(file_path.name, file_pattern)
    ...
    @abstractmethod
    def create_visualization(self, *args, **kwargs) -> Union[str, List[str]]:
        """
...
class MultiplotVisualizer(BaseVisualizer):
    ...
    @abstractmethod
    def _create_outcome_visualizations(
        self, 
        outcome: str, 
        **kwargs
    ) -> List[str]:
    ...
    def _create_summary_visualizations(
        self, 
        outcomes: List[str], 
        **kwargs
    ) -> List[str]:
