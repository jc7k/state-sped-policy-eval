...
class EdFactsCollector(FileBasedCollector):
    ...
    def try_download_patterns(
        self, data_type: str, year: int, output_dir: Path
    ) -> Path | None:
        """
...
def main():
    ...
    parser.add_argument(
        "--data-type",
        choices=["child_count", "exiting", "discipline", "all"],
        default="all",
    ...
    if args.data_type == "all":
        ...
        results = {
            "child_count": collector.collect_child_count_data(args.years, output_dir)
        }
        ...
        results = {
            "discipline": collector.collect_discipline_data(args.years, output_dir)
        }
