...
class OCRCollector:
    ...
    def try_download_year(self, year: int, output_dir: Path) -> Optional[Path]:
        """
            ...
            if file_path:
                ...
                if file_path.suffix.lower() == '.zip':
                    ...
                    for extracted_file in extracted_files:
                        if extracted_file.suffix.lower() == '.csv' and 'state' in extracted_file.name.lower():
...
def main():
    ...
    parser.add_argument('--years', nargs='+', type=int, default=[2015, 2017, 2020],
