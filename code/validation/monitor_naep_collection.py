...
from code.validation.naep_data_validator import NAEPDataValidator
        ...
        if output_file.exists():
            ...
            try:
                ...
                if record_count >= 1200:
                    ...
                    return True, f"Collection in progress - {record_count} records so far"
            except Exception as e:
                return True, f"Collection in progress - file exists but still being written: {e}"
        else:
...
if __name__ == "__main__":
    ...
    parser.add_argument('--max-wait-hours', type=int, default=2,
