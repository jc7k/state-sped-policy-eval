...
class TestStateNameConversion:
    ...
    def test_valid_state_names(self):
        ...
        state_names = {
            'Alabama': 'AL', 'California': 'CA', 'Texas': 'TX',
...
class TestValidateData:
    ...
    def test_valid_dataframe_validation(self):
        ...
        df = pd.DataFrame([
            {'state': 'AL', 'year': 2022, 'total_expenditures': 8500000000, 'enrollment': 745000},
            {'state': 'CA', 'year': 2022, 'total_expenditures': 85000000000, 'enrollment': 6200000}
        ])
    ...
    def test_insufficient_state_coverage(self):
        ...
        df = pd.DataFrame([
            {'state': 'AL', 'year': 2022, 'total_expenditures': 8500000000}
        ])
