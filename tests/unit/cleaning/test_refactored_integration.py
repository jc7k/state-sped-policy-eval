    ...
    def test_create_panel_dataset(self):
        ...
        datasets = {
            "naep": pd.DataFrame({
                "state": ["CA", "NY"],
                "year": [2020, 2020],
                "avg_scale_score": [250, 240]
            }),
            "census": pd.DataFrame({
                "state": ["CA", "NY"], 
                "year": [2020, 2020],
                "total_expenditure": [50000, 60000]
            })
        }
...
class TestDataIntegrator:
    ...
    @patch('code.cleaning.data_loaders.NAEPDataLoader.load_and_clean')
    @patch('code.cleaning.data_loaders.CensusDataLoader.load_and_clean')
